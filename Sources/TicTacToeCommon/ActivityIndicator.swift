...
public struct AlertState<Action>: Equatable {
  ...
  public struct Button {
    ...
    public static func cancel(
      ...
      return Button(action: action, type: .cancel(label: label))
    }

    public static func cancel(
      send action: Action? = nil
    ) -> Button {
        return Button(action: action, type: .cancel(label: nil))
    }
    ...
    public static func `default`(
      ...
      send action: Action? = nil
        ...
        return Button(action: action, type: .default(label: label))
    }
    ...
    public static func destructive(
      ...
      send action: Action? = nil
        ...
        return Button(action: action, type: .destructive(label: label))
    }
